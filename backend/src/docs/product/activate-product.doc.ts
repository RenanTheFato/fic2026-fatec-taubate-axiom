...
export const activateProductDoc = {
  tags: ["product"],
  summary: "Activate an Product",
  description: "Turn an deactivate product into an active and visible publicly",
  security: [
    {
      bearerAuth: [],
    },
